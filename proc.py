...
DONEE_MAP = {
    ...
    "https://mfoundation.org/": "Methuselah Foundation",
    "http://www.experience.camp/": "Experience Camps",
    "https://www.fsf.org/": "Free Software Foundation",
    "https://www.aclu.org": "American Civil Liberties Union",
    "https://www.womenwhotech.com": "Women Who Tech",
    "https://www.calblueprint.org": "Blueprint at University of California, Berkeley",
    "https://www.caninetherapycorps.org": "Canine Therapy Corps",
    "http://ij.org": "Institute for Justice",
    "https://www.treesisters.org": "TreeSisters",
    "https://human-i-t.org/": "human-I-T",
    "https://www.theadventureproject.org/": "The Adventure Project",
    "http://soalliance.org/": "Sustainable Ocean Alliance",
    "http://www.manyhopes.org": "Many Hopes",
    "https://letsencrypt.org/": "Let's Encrypt",
    "http://www.snowlovers.org/": "Snow Lovers",
    "https://www.iamsogal.com/": "SoGal",
    "http://www.trgt.org/": "Tennessee River Gorge Trust",
    "https://www.kde.org/": "KDE e.V.",
    "https://nuzzlesandco.org/": "Nuzzles & Co",
    "http://www.newincentives.org/": "New Incentives",
    "http://www.meaction.net": "Myalgic Encephalomyelitis Action Network",
    "http://csp.org/psilocybin/": "Council on Spiritual Practices",
    "http://alter.global": "Alter Global",
}
